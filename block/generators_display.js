...
Blockly.JavaScript['i2c128x64_display_image'] = function(block) {
  ...
  var code = ` OLED.drawFastImage(${value_x}, ${value_y}, ${value_width},${value_height},${value_img}.data());\n`;
  return code;
};
...
Blockly.JavaScript['i2c128x64_display_print'] = function(block) {
  ...
  var code = 
`
 OLED.setFont(${dropdown_font});
 OLED.drawString(${value_x},${value_y},String(${value_text}));
`;
  return code;
};
...
Blockly.JavaScript['i2c128x64_display_draw_line'] = function(block) {
  ...
  var code = ` OLED.drawLine(${value_x0},${value_y0},${value_x1},${value_y1});\n`;
  return code;
};
...
Blockly.JavaScript['i2c128x64_display_draw_rect'] = function(block) {
  ...
  if(checkbox_fill){
    var code = ` OLED.fillRect(${value_x},${value_y},${value_width},${value_height});\n`;
  }else{
    var code = ` OLED.drawRect(${value_x},${value_y},${value_width},${value_height});\n`;
  }
  return code;
};
...
Blockly.JavaScript['i2c128x64_display_draw_circle'] = function(block) {
  ...
  var checkbox_fill = block.getFieldValue('fill') == 'TRUE';
  if(checkbox_fill){
    var code = ` OLED.fillCircle(${value_x},${value_y},${value_r});\n`;
  }else{
    var code = ` OLED.drawCircle(${value_x},${value_y},${value_r});\n`;
  }  
  return code;
};
...
Blockly.JavaScript['i2c128x64_display_draw_progress_bar'] = function(block) {
  ...
  var code = ` OLED.drawProgressBar(${value_x}, ${value_y}, ${value_width}, ${value_height}, ${value_progress});\n`;
  return code;
};
...
Blockly.JavaScript['i2c128x64_display_draw_pixel'] = function(block) {
  ...
  var code = `
 OLED.setColor(${checkbox_color});
 OLED.setPixel(${value_x}, ${value_y});
 OLED.setColor(WHITE);
`;
  return code;
};
